(function ($) {
    ...
    $('.qtybtn').on('click', function () {
        ...
        var oldpro_subtotal_1 = document.getElementById("pro-subtotal-1").innerText;
        var oldpro_price_1 = document.getElementById("pro-price-1").innerText;
        var oldpro_subtotal_2 = document.getElementById("pro-subtotal-2").innerText;
        var oldpro_subtotal_3 = document.getElementById("pro-subtotal-3").innerText;
        oldpro_subtotal_1 = Number(oldpro_subtotal_1);
        if ($button.hasClass('inc')) {
            var newVal = parseFloat(oldValue) + 1;
            document.getElementById('pro-subtotal-1').innerText = oldpro_price_1 * newVal;
            oldpro_subtotal_1 = oldpro_price_1 * newVal;
            document.getElementById('total-amount').innerText = Number(oldpro_subtotal_1) + Number(oldpro_subtotal_2) + Number(oldpro_subtotal_3) + 70;
        } else {
